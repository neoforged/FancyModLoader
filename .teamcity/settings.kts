...
project {
    ...
    features {
        githubIssues {
            id = "bootstraplauncher__IssueTracker"
            displayName = "McModLauncher/bootstraplauncher"
            repositoryURL = "https://github.com/McModLauncher/bootstraplauncher"
        }
    }
}
